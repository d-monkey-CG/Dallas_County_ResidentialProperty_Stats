...
df_1 = pd.read_csv(
    "/Users/joannasanchez/Downloads/state_TX.csv",
    usecols=cols_needed_detail,
    low_memory=False,
)
df_2 = pd.read_csv(
    "/Users/joannasanchez/Downloads/state_TX-2.csv",
    usecols=cols_needed_detail,
    low_memory=False,
)
df_3 = pd.read_csv(
    "/Users/joannasanchez/Downloads/state_TX-3.csv",
    usecols=cols_needed_detail,
    low_memory=False,
)
df_4 = pd.read_csv(
    "/Users/joannasanchez/Downloads/state_TX-4.csv",
    usecols=cols_needed_detail,
    low_memory=False,
)
df_5 = pd.read_csv(
    "/Users/joannasanchez/Downloads/state_TX-5.csv",
    usecols=cols_needed_detail,
    low_memory=False,
)
...
df["interest_rate"] = pd.to_numeric(df["interest_rate"], errors="coerce").astype(
    "Float64"
)
...
df["applicant_age"] = pd.to_numeric(df["applicant_age"], errors="coerce").astype(
    "Int64"
)

df.info()

df.to_parquet("/Users/joannasanchez/Downloads/HMDA_5yr_clean.parquet", index=False)
